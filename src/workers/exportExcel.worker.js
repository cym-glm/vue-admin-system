...
self.onmessage = function(e) {
  ...
  try {
    ...
    const worksheet = XLSX.utils.json_to_sheet(allData, { skipHeader: !includeHeader })
    ...
    console.log('[Worker] 准备发送完成消息，数据类型:', typeof sendData, '长度:', sendData.length, '前10个字符:', sendData.substring(0, 10))
    self.postMessage({
      type: 'complete',
      fileData: sendData,
